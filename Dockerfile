# .NET 8.0 ASP.NET CHISELED image. No shell, rootless by default, https://github.com/dotnet/dotnet-docker/blob/main/documentation/image-variants.md & https://github.com/dotnet/dotnet-docker/tree/main/src/aspnet/8.0
